...
Après avoir construit une grande partie de ma vie en France, tant sur le plan professionnel que personnel, il me semble important de pouvoir m’impliquer pleinement, notamment en participant aux choix démocratiques. Voter représente pour moi à la fois un droit et une responsabilité, ainsi qu’une manière concrète de contribuer à la vie publique.`,
  ...
  },
  {
    id: 30,
    cat: "Questions personnelles",
    q: "Connaissez-vous des traditions françaises ?",
    r: `Oui, je connais des traditions comme le 14 juillet, Noël, la galette des rois et le 1er mai.`,
    astuce: "14 juillet + Noël",
  },
  {
    id: 31,
    cat: "Questions personnelles",
...
En 1905, la loi de séparation des Églises et de l’État a été promulguée en France. L’État ne finance pas les cultes et établit la neutralité religieuse dans les affaires publiques.`,
  ...
  },
  {
    id: 60,
    cat: "Histoire, culture et société",
    q: "Quelles sont les grandes spécialités culinaires françaises ?",
    r: `On peut citer la baguette, le fromage, le vin, le cassoulet ou le bœuf bourguignon.`,
    astuce: "Baguette + fromage",
  },
  {
    id: 61,
    cat: "Histoire, culture et société",
  ...
  },
{
  ...
  },
  {
    id: 123,
    cat: "République",
    q: "Quand commence la Ve République ?",
    r: `La Ve République commence en 1958 avec l'adoption de la Constitution actuelle.`,
    astuce: "De Gaulle",
  },
  {
    id: 124,
    ...
    r: `C’est le Général Charles de Gaulle qui en est le principal fondateur.`,
    astuce: "De Gaulle = 1958",
  },
  {
    id: 125,
    cat: "République",
    q: "Quand commence la IVe République ?",
    r: `La IVe République commence en 1946, juste après la Seconde Guerre mondiale.`,
    astuce: "Après guerre",
  },
  {
    id: 126,
    cat: "République",
    q: "Pourquoi la IVe République prend-elle fin ?",
    r: `Elle prend fin principalement à cause d’une grande instabilité ministérielle et des difficultés liées à la guerre d’Algérie.`,
    astuce: "Instable",
  },
  {
    id: 127,
    cat: "République",
    q: "Quand commence la IIIe République ?",
    r: `La IIIe République commence en 1870, après la chute de Napoléon III.`,
    astuce: "1870",
  },
  {
    id: 128,
    cat: "République",
    q: "Quelle réforme importante a eu lieu sous la IIIe République ?",
    r: `C’est sous la IIIe République que l’école est devenue gratuite, laïque et obligatoire (lois Jules Ferry).`,
    astuce: "École",
  },
  {
    id: 129,
    cat: "République",
    q: "Quand devient stable la IIIe République ?",
    r: `Elle se stabilise véritablement en 1875 avec le vote des lois constitutionnelles.`,
    astuce: "1875",
  },
  {
    id: 130,
    cat: "République",
    q: "Quand commence la IIe République ?",
    r: `Elle commence en 1848 après la révolution de février.`,
    astuce: "Révolution",
  },
  {
    id: 131,
    cat: "République",
    q: "Quelle avancée majeure a eu lieu en 1848 ?",
    r: `L’instauration du suffrage universel masculin et l'abolition définitive de l'esclavage.`,
    astuce: "Vote",
  },
  {
    id: 132,
    cat: "République",
    q: "Quand commence la Ire République ?",
    r: `La Ire République commence en 1792, après la chute de la monarchie.`,
    astuce: "Révolution",
  },
  {
    id: 133,
  ...
  },
  {
    ...
    cat: "Rois",
    q: "Qui était Clovis ?",
    r: `Clovis a été le premier roi des Francs à unifier les tribus franques et à régner sur une grande partie de la Gaule (481-511).`,
    astuce: "481 à 511",
  },
  {
    id: 135,
    cat: "Rois",
    q: "Pourquoi Clovis est-il important ?",
    r: `Il est important car il est le premier roi barbare à s’être converti au catholicisme, scellant l'alliance entre l'État et l'Église.`,
    astuce: "Religion",
  },
  {
    id: 136,
  ...
  },
  {
    id: 138,
    cat: "Rois",
    q: "Qui était Saint Louis ?",
    r: `Louis IX, dit Saint Louis, était un roi réputé pour sa piété et son sens de la justice (il rendait la justice sous un chêne).`,
    astuce: "Justice",
  },
  {
    id: 139,
    cat: "Rois",
    q: "Qui était Charles VII ?",
    r: `C'est le roi de France qui a été sacré à Reims grâce à l'intervention décisive de Jeanne d'Arc pendant la guerre de Cent Ans.`,
    astuce: "Jeanne d’Arc",
  },
  {
    id: 140,
  ...
  },
  {
    id: 141,
    cat: "Rois",
    q: "Qui était Henri IV ?",
    r: `Henri IV était un roi qui a mis fin aux guerres de religion entre catholiques et protestants en France.`,
    astuce: "Paix",
  },
  {
    id: 142,
    cat: "Rois",
    q: "Quelle décision majeure prend Henri IV ?",
    r: `Il signe l’Édit de Nantes en 1598, qui accorde la liberté de culte aux protestants et rétablit la paix.`,
    astuce: "Tolérance",
  },
  {
    id: 143,
    ...
    r: `Surnommé le "Roi-Soleil", Louis XIV est le symbole de la monarchie absolue de droit divin. Il a fait construire le château de Versailles.`,
    astuce: "Pouvoir",
  },
  {
    id: 144,
  ...
  },
  {
    id: 145,
    cat: "Rois",
    q: "Qui était Louis XVI ?",
    r: `Il était le roi de France au moment du déclenchement de la Révolution française en 1789.`,
    astuce: "1789",
  },
  {
    id: 146,
    ...
    r: `Il a été déchu de ses fonctions, jugé puis exécuté (guillotiné) en 1793.`,
    astuce: "Fin roi",
  },
  {
    id: 147,
...
Les devoirs comprennent le respect des lois, le paiement des impôts, la participation aux jurys d'assises et la défense de la patrie.`,
  ...
  },
  {
    ...
    cat: "Histoire",
    q: "Qui était Napoléon Bonaparte ?",
    r: `Un général de la Révolution devenu Premier Consul puis Empereur des Français sous le nom de Napoléon Ier.`,
    astuce: "Empire",
  },
  {
    id: 195,
    cat: "Histoire",
    q: "Que crée Napoléon qui existe encore ?",
    r: `Il a créé le Code civil (1804), les lycées, la Légion d'honneur et la Cour des comptes.`,
    astuce: "Loi",
  },
  {
    id: 196,
    ...
    r: `Elle s'est déroulée de 1914 à 1918.`,
    astuce: "14-18",
  },
  {
    id: 197,
...
- Le Jura (frontière avec la Suisse)`,
  ...
  },
  {
    ...
    r: "Un immense écrivain, poète et homme politique français, auteur des Misérables.",
    astuce: "Écrivain",
  },
  {
    id: 226,
